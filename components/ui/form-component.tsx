...
const models = [
    { value: "scira-default", label: "GPT-4o-mini", icon: "/openai.svg", iconClass: "!text-neutral-300", description: "OpenAI's ChatGPT-4o-mini model", color: "steel", vision: true, experimental: false, category: "Stable" },
